          ...
          <nav className="container mx-auto px-6 py-4">
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center space-x-4">
                <Link to="/login" className="text-muted rounded-md p-8 hover:text-primary transition-colors hidden sm:inline-flex">
                  Sign In
                </Link>
                <Link to="/register" className="btn-primary rounded-md p-8">
                  Get Started
                </Link>
              </div>
            </div>
